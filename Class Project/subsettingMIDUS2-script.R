...
myvars <- c("M2ID", "M2FAMNUM", "SAMPLMAJ", "B1STATUS", "bage", "B1PRSEX", 
            ...
            "B1SA56R", "B1SA56S", "B2DB2", "B2DB3", "B1SA30A", "B1SA30B", 
            ...
            "B4QCESD", "B4QPS_PS","B1SEARN1", "B1SPNSN1", "B1STINC1", 
            "B1SSEC1", "B1SG7", )

# 2020-02-11 need to add measure for assets, education, and occupation to myvars.
