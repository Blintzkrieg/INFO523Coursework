...
#update all your installed packages WITHOUT having to confirm for each package (Note: as this could take a long time, you don't have to practice this command)
...
```{r}
save(my.function, my.dataset, file="path_to_mysession.RData")
...
setwd("C:/Users/hongcui/Documents/courses/INFO523 DataMining/INFO523_Cui/lecture-R-case")
```
